...
public class TopicosController {
	...
	public ResponseEntity<TopicosDto> detalhar(@PathVariable Long id) {
		Optional<Topico> topico = topicoRepository.findById(id);
		if(topico.isPresent()){
			return ResponseEntity.ok(new TopicosDto(topico.get()));
		}
	...
	@PutMapping("/{id}")
	@Transactional
	public ResponseEntity<TopicosDto> atualizar(@PathVariable Long id, @RequestBody @Valid AtualizaTopicoForm form){
